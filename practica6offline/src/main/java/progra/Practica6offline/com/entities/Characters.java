...
import progra.Practica6offline.com.utils.Position;
...
public class Characters {
	...
	public char[][] moveVampire(char[][] dungeon){
		for(int i=0;i<vampires.size();i++) {
			...
			if(vampires.get(i).getY()-1>=0 && dungeon[vampires.get(i).getY()-1][vampires.get(i).getX()]==Letras.getLetraVacia()) {
				posicionesValidas.add(0);
			}
			if(vampires.get(i).getX()+1<dungeon[0].length && dungeon[vampires.get(i).getY()][vampires.get(i).getX()+1]==Letras.getLetraVacia()) {
				posicionesValidas.add(1);
			}
			if(vampires.get(i).getY()+1<dungeon.length && dungeon[vampires.get(i).getY()+1][vampires.get(i).getX()]==Letras.getLetraVacia()) {
				posicionesValidas.add(2);
			}
			if(vampires.get(i).getX()-1>=0 && dungeon[vampires.get(i).getY()][vampires.get(i).getX()-1]==Letras.getLetraVacia()) {
			...
			if(posicionesValidas.size()>0) {
				...
				dungeon[vampires.get(i).getY()][vampires.get(i).getX()]=Letras.getLetraVacia();
				vampires.get(i).move(mov);
				dungeon[vampires.get(i).getY()][vampires.get(i).getX()]=Letras.getLetraVampire();
			}
		}
